...
use PDOException;
 ...
 class MyPDO extends  PDO {
    ...
    public function __construct() {
        ...
        try {
            //اطلاعات اتصال به دیتابیس
             ...
             app::out("Problem connecting database");
          }
    }
    ...
    */
    public static  function doSelect($sql, $values = array(), $fetchAll = true,  $autoErroResponder = true ,$fetchStyle = PDO::FETCH_ASSOC)
    {
        ...
        try {
            ...
            if($autoErroResponder)  app::out("Internal Server Error" ,  HTTP_INTERNAL_SERVER_ERROR  ) ;
            else return $ex;
        }
     ...
     */
    public static  function doQuery($sql, $values = [] ,  $autoErroResponder = true )
    {
